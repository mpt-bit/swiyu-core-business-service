...
- skip SNYK-JAVA-ORGXERIALSNAPPY-19964087

## 4.0.5

### Changed

- fix openapi configuration to avoid introspecting JsonNode class

## 4.0.4

### Fixed

- Resolve sonar findings (misleading comment in ArchitectureTest, duplicated test body in DevopsInternalControllerIT)

## 4.0.3

### Added

- Publish TiBusinessPartnerUpdatedEvent on business partner create/update and DevOps sync endpoints.

## 4.0.2

### Changed

- Update dependencies: archunit, spotless, sonar, greenmail, jackson-databind-nullable, openapi-generator, didresolver, openfeign-querydsl, kotlin, pdfbox, bcprov, jackson, commons-codec, mockserver, and docker-compose images

## 4.0.1

### Changed

- Extend support of nullability for BusinessPartnerType
